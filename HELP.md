...
* The original package name 'io.kmaker.spring-batch-concept' is invalid and this project uses 'io.kmaker.spring_batch_concept' instead.
...
```
$ docker run --rm -p 8080:8080 spring-batch-concept:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/spring-batch-concept
```
